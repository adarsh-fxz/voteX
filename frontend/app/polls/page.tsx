        ...
        <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 max-w-xl text-base leading-8 text-muted-foreground">
              Review the latest on-chain polls, inspect participation state, and jump
              directly into individual voting flows from a polished, responsive surface.
            </p>
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="glass-panel rounded-[1.4rem] px-4 py-4">
              <ShieldCheck className="size-5 text-primary" />
              <p className="mt-3 text-sm font-medium text-foreground">Inspectable state</p>
              <p className="mt-1 text-sm text-muted-foreground">Pulls directly from the VoteX program.</p>
            </div>
            <div className="glass-panel rounded-[1.4rem] px-4 py-4">
              <ChartNoAxesCombined className="size-5 text-primary" />
              <p className="mt-3 text-sm font-medium text-foreground">Results ready</p>
              <p className="mt-1 text-sm text-muted-foreground">Jump from overview to detail without losing context.</p>
            </div>
          </div>
        </div>
      </div>
